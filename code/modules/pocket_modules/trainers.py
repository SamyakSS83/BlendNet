...
class Pseq2SitesTrainer():
    ...
    def train(self, loader):
        ...
        for batch in tqdm(loader):
            prots_data, total_prots_data, prots_mask, position_ids, labels = batch[0], batch[1], batch[2], batch[3], batch[4]
    ...
    def eval(self, loader, i):
        ...
        if self.best_eval_loss > losses / len(loader):
            torch.save(self.model.state_dict(), f"{self.config['Path']['save_path']}/CV{i}/pocket_extractor.pth")
