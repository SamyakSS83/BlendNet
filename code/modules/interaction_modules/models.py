...
class BlendNetT(nn.Module):
    ...
    def forward(self, protein_data, compound_graphs, pocket_masks, compound_masks):
        ...
        # Cross encoder
        residue_representations, node_representations = self.cross_encoder(residue_representations, pocket_extend_attention_masks, node_representations, compound_extended_attention_masks, pocket_masks, compound_masks)        # Interacton encoder
